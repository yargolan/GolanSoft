...
import com.ygsoft.apps.utilsandwrappers.Messages;
...
public class Mp3FilesTags extends JFrame {
    ...
    private JButton btnLast, btnPrev, btnFirst, btnUpdate, btnNext;
    private JTextField tfRootFolder = new JTextField();
    private JTextField tfFileName   = new JTextField();
    private JTextField tfSongTitle  = new JTextField();
    private JTextField tfAlbumName  = new JTextField();
    private JTextField tfSongArtist = new JTextField();


    private static Logger logger = LogManager.getLogger(Mp3FilesTags.class);
    ...
    private void actionPerformedUpdate() {
        ...
        Messages.showMessage(Messages.MESSAGE_TYPE_INFO, "Updated successfully.");
    }
