...
import com.ygsoft.apps.b1.data.DataSingleton;
import com.ygsoft.apps.b1.data.Profile;
...
public class BackupUi {
    ...
    private void addActionListeners() {
        ...
        bProfileRun.addActionListener(e->{
            ...
            if (output.isEmpty()) {
                ...
                Messages.error("Errors while running the b1. Please look into the log.");
            }
        });
    }
    ...
    private void createNewProfile() {
        ...
        JLabel     lItemToBackup   = new JLabel("Item to b1 :");
        ...
        bCreateProfile.addActionListener(e->{
            ...
            if (items == null || items.isEmpty()) {
                Messages.error("No items to b1 provided.");
                return;
            }
