...
public class BackupProfile {
    ...
    void parse() throws IOException {
        ...
        if ( ! currentProfile.exists()) {
            throw new IOException(String.format(
                    "Cannot find the profile's file for '%s'", this.profileName
            ));
        }
    ...
    void generateProfileFile() throws IOException {
        ...
        if (newProfileFile.exists()) {
            throw new IOException("The profile's file already exist.");
        }
        ...
        try {
            ...
            throw new IOException("Cannot generate the profile's file.", e);
        }
    }
}
