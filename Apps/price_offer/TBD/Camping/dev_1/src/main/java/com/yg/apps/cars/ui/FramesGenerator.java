...
public class FramesGenerator {
    ...
    // Frames
    public static final int F_MAIN             = 11;
    public static final int F_GARAGE_ADD       = 21;
    public static final int F_GARAGE_EDIT      = 22;
    public static final int F_MAINTENANCE_ADD  = 31;
    public static final int F_MAINTENANCE_EDIT = 32;
