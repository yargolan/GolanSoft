...
public class ProfilesGenerator {
    ...
    void generate() {
        ...
        JLabel lItemsToBackup = new JLabel("Items to backup:");
        ...
        bGenerate      = new JButton("Generate profile");
    ...
    private void addActionListeners() {
        ...
        bGenerate.addActionListener(e->{
            ...
            if (readProfileName == null || readProfileName.isEmpty()) {
                Messages.showMessage(Messages.MESSAGE_ERR, "Invalid profile name provided.");
                return;
            }
            ...
            if (readItemsToBackup == null || readItemsToBackup.isEmpty()) {
                Messages.showMessage(Messages.MESSAGE_ERR, "No items to backup. Invalid profile.");
                return;
            }


            // Set the info into a 'profile' object
            List<String> itemsToBackup = Arrays.asList(readItemsToBackup.split("\n"));
            Profile profile = new Profile(readProfileName, readProfileHost, readTargetFolder, itemsToBackup);
            ...
            try {
                ...
                Messages.showMessage(Messages.MESSAGE_ERR, "Cannot add the profile: " + ex.getMessage());
                return;
            }
            Messages.showMessage(Messages.MESSAGE_INF, String.format(
                    "The profile '%s' was successfully created.", readProfileName
            ));
        });
    }
